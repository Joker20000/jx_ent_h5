  ...
  <div class="sign_list">
    <div class="screen">
      ...
      <div class="select" v-if="!selectTaskSearch">
        <div class="company" @click="taskSelectCilck()" v-bind:class="{'color_text':selectTaskName !='' }">
          <span class="three" v-show="selectTaskName ==''" ><img src="../../../../static/image/jx_search.png" ></span>
          <span class="three" v-show="selectTaskName !=''" ><img src="../../../../static/image/jx_search_blue.png" ></span>
      ...
      <div class="input_box" v-if="selectTaskSearch">
        ...
        <div class="input_cancel" v-on:click="cancelFn">取消</div>
      </div>
